  ...
  <head>
    ...
    <style>
      ...
      .container {
        ...
        border-radius: 16px;
        box-shadow: 0 0 30px rgba(255, 0, 0, 0.8), 0 0 60px rgba(255, 0, 0, 0.8), inset 0 0 20px rgba(255, 0, 0, 0.5);
      }
  ...
  <head>
    ...
    <style>
      ...
      input {
        ...
        margin-top: 5px;
        border-radius: 8px;
        border: 2px solid #7c0000; /* Red neon color */
        background-color: black;
        color: #fff;
	outline-color: #7c0000; /* Red neon color */
      }
  ...
  <body>
    <div class="container">
      ...
      <div id="generatedURLContainer">
        <textarea class='text-box' rows="4" cols="32" id='generatedURL' readonly></textarea>
        <div id="copyButton">
